...
const CustomLink = ({ href, children }) => (
  <a href={href} className="hover:text-orange-400 dark:hover:text-amber-600 px-3 py-2">{children}</a>
);
...
export default function Home() {
  ...
  return (
    <div>
      {/* Header Navbar */}
      <header className="bg-stone-700 text-white py-4">
        <div className="container mx-auto flex justify-between items-center">
          {/* Logo with Margin */}
          <div className="ml-10">
            <Link href="/">
              <Image
                src="/logo/purenars.png"
                alt="Logo"
                width={115}
                height={50}
          ...
          {/* Navigation Links */}
          <nav className="justify-between space-x-4 mr-12 font-semibold text-xl">
            <CustomLink href="/categories">Limited Items</CustomLink>
         ...
         <div className="relative mr-16">
            <HiUser
              className="text-4xl cursor-pointer hover:text-orange-400 dark:hover:text-orange-700"
          ...
          <div key={product.id} className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow p-4 mb-6">
            ...
            <div className="px-5 pb-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-white bg-orange-400 hover:bg-amber-600 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add to cart</a>
              </div>
            </div>
          </div>
        ))}
